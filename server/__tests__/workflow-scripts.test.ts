 ...
 */
function detectBundleOutputPath(availablePaths: string[]): BundleOutputPattern | null {
...
describe("bundle-analyze: bundle output path detection (lines 31-37)", () => {
  ...
  it("prefers CRA path over Vite path when both have .js files", () => {
    ...
    expect(
      detectBundleOutputPath(["build/static/js/main.abc123.js", "dist/assets/index.xyz789.js"]),
  ...
  it("matches multiple .js files in the same directory", () => {
    expect(
      detectBundleOutputPath(["build/static/js/main.abc.js", "build/static/js/vendor.def.js"]),
    ).toBe("build/static/js");
  });
});
