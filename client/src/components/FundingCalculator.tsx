    ...
    <Card className="glass-panel" data-testid="funding-calculator">
      ...
      <CardContent>
        <p className="text-sm text-muted-foreground mb-6">
          Adjust the surcharge rates to explore different funding scenarios. See how changes affect
          total revenue, jobs created, and students fed.
        </p>
          ...
          <div className="space-y-4">
            ...
            >
              <div className="p-4 bg-primary/10 rounded-xl">
                ...
                <p className="text-2xl font-bold text-primary">
                  {formatMoney(calculations.totalRevenue)}
                </p>
              </div>
              ...
              <div className="p-4 bg-emerald-500/10 rounded-xl">
                ...
                <p className="text-2xl font-bold text-emerald-600">
                  {formatMoney(calculations.excessRevenue)}
                </p>
              </div>
            </motion.div>
            ...
            <div className="p-3 bg-muted/50 rounded-lg">
              <p className="text-xs text-muted-foreground">
                <strong>Note:</strong> These projections are estimates based on proposed surcharge
                rates. The core endowment target is $5B @ 4.5% = $225M/year, with excess funds
                allocated to tribal programs, mining alternatives, and distribution infrastructure.
              </p>
            </div>
          </div>
        </div>
