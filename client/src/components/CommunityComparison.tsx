...
const MINNESOTA_COMMUNITIES: CommunityData[] = [
  // CO2 = avoided transport emissions: (students × 75 lbs / 2000) × 1,200 mi × 161.8 g/ton-mi / 1M
  {
    ...
    schools: 660,
    students: 495000,
    greenhouseSqft: 6600000,
    jobs: 1320,
    produceAnnual: 37125000,
    endowmentShare: 2750000000,
    co2Tons: 3604,
  },
  {
    name: "Rochester Area",
    ...
    schools: 65,
    students: 48750,
    greenhouseSqft: 650000,
    jobs: 130,
    produceAnnual: 3656250,
    endowmentShare: 270833333,
    co2Tons: 355,
  },
  {
    name: "Duluth/Iron Range",
    region: "Northeast",
    schools: 125,
    students: 93750,
    greenhouseSqft: 1250000,
    jobs: 250,
    produceAnnual: 7031250,
    endowmentShare: 520833333,
    co2Tons: 683,
  },
  {
    name: "St. Cloud Area",
    ...
    schools: 80,
    students: 60000,
    greenhouseSqft: 800000,
    jobs: 160,
    produceAnnual: 4500000,
    endowmentShare: 333333333,
    co2Tons: 437,
  },
  {
    name: "Mankato/Southern MN",
    region: "South",
    schools: 110,
    students: 82500,
    greenhouseSqft: 1100000,
    jobs: 220,
    produceAnnual: 6187500,
    endowmentShare: 458333333,
    co2Tons: 601,
  },
  {
    name: "Moorhead/Red River Valley",
    region: "Northwest",
    schools: 60,
    students: 45000,
    greenhouseSqft: 600000,
    jobs: 120,
    produceAnnual: 3375000,
    endowmentShare: 250000000,
    co2Tons: 328,
  },
  {
    name: "Alexandria/Lakes Region",
    region: "West Central",
    schools: 55,
    students: 41250,
    greenhouseSqft: 550000,
    jobs: 110,
    produceAnnual: 3093750,
    endowmentShare: 229166667,
    co2Tons: 300,
  },
  {
    name: "Tribal Nations (Combined)",
    region: "Statewide",
    schools: 45,
    students: 33750,
    greenhouseSqft: 450000,
    jobs: 90,
    produceAnnual: 2531250,
    endowmentShare: 187500000,
    co2Tons: 245,
  },
];
              ...
              <SelectContent>
                {MINNESOTA_COMMUNITIES.map((c) => (
                  <SelectItem
                    key={c.name}
                    value={c.name}
                    data-testid={`option-community-1-${c.name.toLowerCase().replace(/[^a-z]/g, "-")}`}
                  >
              ...
              <SelectContent>
                {MINNESOTA_COMMUNITIES.map((c) => (
                  <SelectItem
                    key={c.name}
                    value={c.name}
                    data-testid={`option-community-2-${c.name.toLowerCase().replace(/[^a-z]/g, "-")}`}
                  >
                    <span className="flex items-center gap-2">
                      <MapPin className="h-3 w-3" />
                      {c.name}
          ...
          <Table data-testid="table-community-comparison">
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-right" data-testid="th-community-1">
                  {community1}
                </TableHead>
                <TableHead className="text-right" data-testid="th-community-2">
                  {community2}
                </TableHead>
              </TableRow>
            </TableHeader>
                ...
                <TableRow key={metric.label} data-testid={`row-metric-${idx}`}>
                  <TableCell>
                    <div
                      ...
                      data-testid={`cell-metric-label-${idx}`}
                    >
                      {metric.icon}
                      {metric.label}
                    </div>
                  ...
                  <TableCell
                    ...
                    data-testid={`cell-metric-value1-${idx}`}
                  >
                    {metric.format(metric.value1)}
                  </TableCell>
                  <TableCell
                    className="text-right text-sm font-medium"
                    data-testid={`cell-metric-value2-${idx}`}
                  >
